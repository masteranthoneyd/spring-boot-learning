...
/**
 * 基于Twitter的Snowflake算法实现分布式高效有序ID生产器
 * <p>
 * <br>
 ...
 * @author ybd
 */
public class SnowflakeSequencer {
	...
	public static final SnowflakeSequencer INSTANCE = new SnowflakeSequencer(1, 1);
	/**
	 * 基于Snowflake创建分布式ID生成器
	 * @param workerId     工作机器ID,数据范围为0~31
	 * @param dataCenterId 数据中心ID,数据范围为0~31
	 */
	private SnowflakeSequencer(long workerId, long dataCenterId) {
